...
interface Analytics {
    ...
    topPerformers: { _id: string; name: string; email: string; department: string; performanceScore: number }[];
    recentProjects: { _id: string; name: string; clientName: string; status: string; priority: string; deadline: string; teamLeadId?: { name: string } }[];
...
export default function ReportsPage() {
    ...
    const { overview, topPerformers, recentProjects, departmentStats, tasksByStatus, leadsByStatus } = analytics;
    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-muted-foreground">Full overview of your organization's performance and metrics.</p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            {overview.totalInterns} interns, {overview.totalTeamLeads} team leads
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{overview.taskCompletionRate}%</div>
                        <Progress value={overview.taskCompletionRate} className="mt-2 h-2" />
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{overview.leadConversionRate}%</div>
                        <Progress value={overview.leadConversionRate} className="mt-2 h-2" />
                    </CardContent>
                </Card>
            </div>
                                ...
                                {leadsByStatus.map((item) => (
                                    <div key={item._id} className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-sm font-medium">{item.count}</span>
                                            <span className="text-xs text-muted-foreground">
                                                ({overview.totalLeads > 0 ? Math.round((item.count / overview.totalLeads) * 100) : 0}%)
                                            </span>
                                        </div>
                                    </div>
                                ))}
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Interns with highest performance scores</CardDescription>
                            </CardHeader>
                            <CardContent>
                                            ...
                                            <div key={dept._id} className="space-y-2">
                                                <div className="flex justify-between text-sm">
                                                    ...
                                                    <span className="text-muted-foreground">
                                                        {dept.count} interns • {Math.round(dept.avgScore || 0)}% avg
                                                    </span>
                                                </div>
                ...
                <TabsContent value="projects">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Latest projects in the organization</CardDescription>
                        </CardHeader>
                        <CardContent>
                                    ...
                                    <TableBody>
                                        {recentProjects.map((project) => (
                                            <TableRow key={project._id}>
                                                ...
                                                <TableCell>{project.teamLeadId?.name || 'Unassigned'}</TableCell>
                                                <TableCell>
                ...
                <TabsContent value="tasks">
                    <div className="grid gap-4 md:grid-cols-3">
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-3xl font-bold">{overview.pendingTasks}</div>
                ...
                <TabsContent value="leads">
                    <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-3xl font-bold text-indigo-600">{overview.leadConversionRate}%</div>
                                <Progress value={overview.leadConversionRate} className="mt-2 h-2" />
                            </CardContent>
                        </Card>
                    </div>
