...
import { CheckSquare, TrendingUp, Clock, Calendar, Briefcase } from 'lucide-react';
                            ...
                            <TableBody>
                                {projects.map((project: any) => {
                                    ...
                                    const projectTasks = tasks.filter((t: any) => 
                                        typeof t.projectId === 'object' && t.projectId._id === project._id
                                    );
                                    const completedTasksCount = projectTasks.filter((t: any) => t.status === 'completed').length;
                                    const totalTasks = projectTasks.length;
                                    
                                    // Use actual project status
                                    let statusColor = 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-400 border-slate-200';
                                    
                                    switch (project.status) {
                                        case 'completed':
                                            statusColor = 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 border-green-200';
                                            break;
                                        case 'active':
                                            statusColor = 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 border-blue-200';
                                            break;
                                        case 'on_hold':
                                            statusColor = 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400 border-orange-200';
                                            break;
                                        case 'planning':
                                            statusColor = 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400 border-purple-200';
                                            break;
                                    }
                                    ...
                                    return (
                                        <TableRow key={project._id}>
                                            ...
                                            <TableCell>
                                                <span className="text-sm text-slate-700">{project.clientName || 'N/A'}</span>
                                            </TableCell>
                                            <TableCell>
